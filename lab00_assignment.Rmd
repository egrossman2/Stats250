...
*Answer:* Quantitative variables are bill_length_mm, bill_depth_mm, flipper_length_mm, and body_mass_g.
...
*Answer:* The other common error is duplicating a chunk name (or reusing a chunk name). This arises from copying and pasting an entire code chunk, backticks and chunk name included. Each code chunk must have a *unique* name, otherwise the R Markdown file will fail to knit.
...
*Answer:* I feel comfortable using R. In high school, I took a class called data analytics that was entirely taught using R so I am comfortable with both R and RStudio.



> **2.** How do you think statistics will help you in your major or future career?

*Answer:* I am very interested in graphical analysis and quantitative research. I hope to pursue a career in finance, so understanding how numbers work and how statistics plays into analysis is something I hope to carry with me forever.
