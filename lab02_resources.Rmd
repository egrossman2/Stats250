...
**THINK-PAIR-SHARE #1:** While neither of the above plots are "surprising", are there any additional variables in the data set that could potentially be considered *confounding* variables? What must be shown for a variable to be considered a confounding variable?
